...
- Name: header_navigation.spec.ts >> Header Navigation Suite - Desktop (1280x800) >> Desktop: CTA 'Apply for Academy' button navigates to /courses/apply
- Location: tests/header_navigation.spec.ts:69:7
...
Expected pattern: /\/courses\/apply$/
