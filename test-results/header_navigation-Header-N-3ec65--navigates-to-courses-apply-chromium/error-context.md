...
- Name: header_navigation.spec.ts >> Header Navigation Suite - Desktop (1280x800) >> Desktop: Intake Portal navigates to /courses/apply
- Location: tests/header_navigation.spec.ts:60:7
...
Locator: locator('header nav a[href=\'/courses/apply\']')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('header nav a[href=\'/courses/apply\']')
