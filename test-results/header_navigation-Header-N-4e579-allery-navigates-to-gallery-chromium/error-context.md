...
- Name: header_navigation.spec.ts >> Header Navigation Suite - Desktop (1280x800) >> Desktop: Gallery navigates to /gallery
- Location: tests/header_navigation.spec.ts:42:7
...
Locator: locator('header nav a[href=\'/gallery\']')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('header nav a[href=\'/gallery\']')
