        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
              Founded by Head LPGA Master Coach Karol Priscila, KP Elite Golf Academy was born from a simple conviction: every golfer possesses a repeatable, effortless swing waiting to be unlocked through 3D kinematic science rather than guesswork.
            </p>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative aspect-[4/5] rounded-3xl overflow-hidden border-2 border-[#D4AF37]/40 shadow-2xl">
              <Image
                src="/coaches/coach-1-karol-head-lpga.jpg"
                alt="Karol Priscila in the Golf Biomechanics Lab"
                fill
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl bg-[#0D1117]/90 backdrop-blur-md border border-[#30363D]">
                <p className="font-serif font-bold text-sm text-white">Karol Priscila, LPGA Master</p>
